...
export const categories = [
  ...
  },
  {
    ...
    items: [
      { id: 'des1', name: 'Salade de Fruits', price: 15, image: '/images/dessert-peche-lotus.png', descKey: '' },
      { id: 'des2', name: 'Pêché Gourmand', price: 20, image: '/images/dessert-peche.png', descKey: '' },
